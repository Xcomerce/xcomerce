...
const statusColors: Record<string, string> = {
  ...
  AGUARDANDO_CONFIRMACAO_EXTERNA: 'bg-amber-100 text-amber-700',
  COMPROVANTE_ENVIADO: 'bg-amber-100 text-amber-700',
  PAGAMENTO_CONFIRMADO: 'bg-emerald-100 text-emerald-700',
  PAGAMENTO_INFORMADO: 'bg-amber-100 text-amber-700',
  ENVIO_INFORMADO: 'bg-blue-100 text-blue-700',
