    ...
    <SafeAreaView className="flex-1 bg-white">
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} className="flex-1">
        <ScrollView contentContainerClassName="px-6 py-8" keyboardShouldPersistTaps="handled">
          <Text className="text-2xl font-bold text-brand-dark">Cadastro comprador</Text>
          <View className="mt-6 gap-4">
            ...
            <View className="flex-row items-center gap-3">
              ...
              <Text className="flex-1 text-sm text-slate-600">Aceito os termos de uso e política de privacidade (LGPD)</Text>
            </View>
