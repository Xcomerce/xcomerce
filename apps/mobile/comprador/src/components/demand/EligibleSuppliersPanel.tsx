...
export function EligibleSuppliersPanel({ categorySlug, categoryName, cidade, uf }: Props) {
  ...
  if (isSearching) {
    return (
      <Card className="bg-slate-50">
        ...
        <Text className="mt-1 text-xs text-slate-500">Mapeando parceiros compatíveis com a categoria e a localização informada.</Text>
      </Card>
    )
  }
