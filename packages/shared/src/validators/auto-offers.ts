...
export const AUTO_OFFER_SKIP_REASON_LABELS: Record<string, string> = {
  ...
  demand_not_found: 'Pedido não encontrado',
  demand_not_open: 'Pedido não está aberto',
  no_match: 'Sem match com o pedido',
  offer_exists: 'Proposta já enviada',
  below_min_qty: 'Quantidade do pedido abaixo do mínimo',
  above_max_qty: 'Quantidade do pedido acima do máximo',
